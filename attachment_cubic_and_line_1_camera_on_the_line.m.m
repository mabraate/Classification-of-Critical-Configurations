...
clc; clear all
syms a1 a2 a3 b4 s t u v x y real
...
P4=[1,0,0,b4;0,1,0,0;0,0,1,0]           %One camera on the line
...
F14=[0,1,-1;-1,1-a1,a1+b4;a1,-a1-b4,-b4*(a1-1)]
F24=[0,a1*a2,-a2^2;-a1*a2,-a2^2*(a1-1),b4*a1^2+a2^3;a1*a2^2,-b4*a1^2-a2^3,-a1*a2*b4*(a1-1)]
F34=[0,a1*a3,-a3^2;-a1*a3,-a3^2*(a1-1),b4*a1^2+a3^3;a1*a3^2,-b4*a1^2-a3^3,-a1*a3*b4*(a1-1)]
